...
namespace Convinience
{
    public class Main
    {
        ...
        class Patch
        {
            ...
            static void MiGameInputUpdate(MiGameInput __instance)
            {
            ...
            static void MiCamBirdviewGameTacticsStart()
            {
                zoomOutNext = true;
            }
            ...
            static void MiCamBirdviewGameTacticsUpdate(MiCamBirdviewGameTactics __instance)
            {
